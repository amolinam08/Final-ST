...
//			e.printStackTrace();
    	...
    	try
		{
			...
			VOTipoBebida tipoBebida1 = hotelandes.adicionarTipoBebida (nombreTipoBebida1);
			lista = hotelandes.darVOTiposBebida();
			...
			VOTipoBebida tipoBebida2 = hotelandes.adicionarTipoBebida (nombreTipoBebida2);
			lista = hotelandes.darVOTiposBebida();
			...
			long tbEliminados = hotelandes.eliminarTipoBebidaPorId (tipoBebida1.getId ());
			...
			// Prueba de eliminación de un tipo de bebida, dado su identificador
			tbEliminados = hotelandes.eliminarTipoBebidaPorNombre (nombreTipoBebida2);
			assertEquals ("Debe haberse eliminado un tipo de bebida !!", 1, tbEliminados);
			lista = hotelandes.darVOTiposBebida();
...
//			e.printStackTrace();
		...
		try
		{
			...
			VOTipoBebida tipoBebida2 = hotelandes.adicionarTipoBebida (nombreTipoBebida1);
