...
/**
 * Clase que encapsula los métodos que hacen acceso a la base de datos para el concepto VISITAN de HotelAndes
...
class SQLVisitan 
{
	 ...
	 */
	public SQLVisitan (PersistenciaHotelAndes pp)
	{
		this.pp = pp;
	}
	
	/**
	 * Crea y ejecuta la sentencia SQL para adicionar un VISITAN a la base de datos de HotelAndes
	...
	/**
	 * Crea y ejecuta la sentencia SQL para eliminar TODAS LAS VISITAS de la base de datos de HotelAndes
	 * @param pm - El manejador de persistencia
	...
	/**
	 * Crea y ejecuta la sentencia SQL para eliminar UN VISITAN de la base de datos de HotelAndes, por sus identificadores
	 * @param pm - El manejador de persistencia
	 * @param idBebedor - El identificador del bebedor
	 * @param idBar - El identificador del bar
	 * @return EL número de tuplas eliminadas
	...
	/**
	 * Crea y ejecuta la sentencia SQL para ELIMINAR TODAS LAS VISITAS DE UN BEBEDOR de la base de datos de HotelAndes, por su identificador
	 * @param pm - El manejador de persistencia
	 * @param idBebedor - El identificador del bebedor
	 * @return EL número de tuplas eliminadas
	 */
	...
	/**
	 * Crea y ejecuta la sentencia SQL para ELIMINAR TODAS LAS VISITAS HECHAS A UN BAR de la base de datos de HotelAndes, por su identificador
	 * @param pm - El manejador de persistencia
	 * @param idBar - El identificador del bar
	 * @return EL número de tuplas eliminadas
	 */
