...
class SQLTipoBebida 
{
	 ...
	 */
	public SQLTipoBebida (PersistenciaHotelAndes pp)
	{
		this.pp = pp;
	}
	...
	/**
	 * Crea y ejecuta la sentencia SQL para eliminar TIPOS DE BEBIDA de la base de datos de HotelAndes, por su nombre
	 * @param pm - El manejador de persistencia
	...
	/**
	 * Crea y ejecuta la sentencia SQL para eliminar TIPOS DE BEBIDA de la base de datos de HotelAndes, por su identificador
	 * @param pm - El manejador de persistencia
	 * @param idTipoBebida - El identificador del tipo de bebida
	 * @return EL número de tuplas eliminadas
	 */
