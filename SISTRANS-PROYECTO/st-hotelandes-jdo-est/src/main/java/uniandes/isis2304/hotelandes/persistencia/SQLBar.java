...
class SQLBar 
{
	...
	/**
	 * Crea y ejecuta la sentencia SQL para eliminar BARES de la base de datos de HotelAndes, por su nombre
	 * @param pm - El manejador de persistencia
	...
	/**
	 * Crea y ejecuta la sentencia SQL para eliminar UN BAR de la base de datos de HotelAndes, por su identificador
	 * @param pm - El manejador de persistencia
	 * @param idBar - El identificador del bar
	 * @return EL número de tuplas eliminadas
	 */
