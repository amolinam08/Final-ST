...
//			e.printStackTrace ();
	...
	public void limpiarBD ()
	{
		try {
			...
			resultado+=eliminados[24] +" Tipoplanconsumo   Eliminados\n";
			resultado+=eliminados[25] +" Restricciones   Eliminados\n";
			resultado+=eliminados[26] +" Servicioprestamoutensilio   Eliminados\n";
			resultado+=eliminados[27] +" Productoplanconsumo   Eliminados\n";
			resultado+=eliminados[28] +" Cartaproductosproductos   Eliminados\n";
			resultado+=eliminados[29] +" Serviciohorarioservicio   Eliminados\n";
			resultado+=eliminados[30] +" Consumoofertaservicio   Eliminados\n";
			resultado+=eliminados[31] +" Consumomuebleconconsumo   Eliminados\n";
			resultado+=eliminados[32] +" Planconsumoservicio   Eliminados\n";
			resultado+=eliminados[33] +" Hotelusuario   Eliminados\n";
			resultado+=eliminados[34] +" Planconsumorestricciones   Eliminados\n";
			resultado+=eliminados[35] +" Usuarioplanconsumo   Eliminados\n";
			resultado+=eliminados[36] +" Hotelplanconsumo   Eliminados\n";
			resultado+=eliminados[37] +" Consumocostoadicional   Eliminados\n";
			resultado += "\nLimpieza terminada";
			panelDatos.actualizarInterfaz(resultado);
		} catch (Exception e) {
			//			e.printStackTrace();
