...
public class HotelAndes 
{
	...
	/**
	 * Encuentra todos los tipos de bebida en HotelAndes
	 * Adiciona entradas al log de la aplicación
	...
	/**
	 * Encuentra todos los tipos de bebida en HotelAndes y los devuelve como una lista de VOTipoBebida
	 * Adiciona entradas al log de la aplicación
	...
	/**
	 * Encuentra el tipos de bebida en HotelAndes con el nombre solicitado
	 * Adiciona entradas al log de la aplicación
	...
	/**
	 * Encuentra todas las bebida en HotelAndes
	 * Adiciona entradas al log de la aplicación
	...
	/**
	 * Encuentra todos los bebedores en HotelAndes
	 * Adiciona entradas al log de la aplicación
	...
	/**
	 * Encuentra todos los bebedores en HotelAndes y los devuelve como VOBebedor
	 * Adiciona entradas al log de la aplicación
	...
	/**
	 * Encuentra todos los bares en HotelAndes
	 * Adiciona entradas al log de la aplicación
	...
	/**
	 * Encuentra todos los bares en HotelAndes y los devuelce como VO
	 * Adiciona entradas al log de la aplicación
	 * @return Una lista de objetos Bar con todos las bares que conoce la aplicación, llenos con su información básica
	 */
	...
	/**
	 * Encuentra todos los gustan en HotelAndes
	 * Adiciona entradas al log de la aplicación
	...
	/**
	 * Encuentra todos los gustan en HotelAndes y los devuelve como VO
	 * Adiciona entradas al log de la aplicación
	 * @return Una lista de objetos Gustan con todos los GUSTAN que conoce la aplicación, llenos con su información básica
	 */
	...
	/**
	 * Encuentra todos los SIRVEN en HotelAndes
	 * Adiciona entradas al log de la aplicación
	...
	/**
	 * Encuentra todos los sirven en HotelAndes y los devuelve como VO
	 * Adiciona entradas al log de la aplicación
	...
	/**
	 * Encuentra todos los VISITAN en HotelAndes
	 * Adiciona entradas al log de la aplicación
	...
	/**
	 * Encuentra todos los visitan en HotelAndes y los devuelve como VO
	 * Adiciona entradas al log de la aplicación
