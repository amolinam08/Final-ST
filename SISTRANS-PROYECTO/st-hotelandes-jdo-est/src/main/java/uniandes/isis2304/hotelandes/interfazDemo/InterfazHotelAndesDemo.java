...
//			e.printStackTrace ();
    ...
    public void demoTipoBebida( )
    {
    	try 
    	{
			...
			VOTipoBebida tipoBebida = hotelandes.adicionarTipoBebida (nombreTipoBebida);
			if (tipoBebida == null)
			{
				tipoBebida = hotelandes.darTipoBebidaPorNombre (nombreTipoBebida);
				errorTipoBebida = true;
			}
			List <VOTipoBebida> lista = hotelandes.darVOTiposBebida();
			long tbEliminados = hotelandes.eliminarTipoBebidaPorId (tipoBebida.getId ());
...
//			e.printStackTrace();
	...
	public void demoBebida( )
    {
    	try 
    	{
			...
			VOBebida bebida = hotelandes.adicionarBebida(nombreBebida, tipoBebida.getId (), 10);
			
			List <VOTipoBebida> listaTiposBebida = hotelandes.darVOTiposBebida();
			List <VOBebida> listaBebidas = hotelandes.darVOBebidas();
			long bebEliminadas = hotelandes.eliminarBebidaPorNombre(nombreBebida);
			long tbEliminados = hotelandes.eliminarTipoBebidaPorId (tipoBebida.getId ());
...
//			e.printStackTrace();
    ...
    public void demoElimNoServidas1 ( )
    {
    	try 
    	{
			...
			VOBebida bebida1 = hotelandes.adicionarBebida("120", tipoBebida.getId (), 10);
			VOBebida bebida2 = hotelandes.adicionarBebida("Gato Negro", tipoBebida.getId (), 11);
			VOBebida bebida3 = hotelandes.adicionarBebida("Don Pedro", tipoBebida.getId (), 12);
			
			List <VOTipoBebida> listaTiposBebida = hotelandes.darVOTiposBebida();
			List <VOBebida> listaBebidas1 = hotelandes.darVOBebidas();
			List <VOSirven> listaSirven = hotelandes.darVOSirven ();
			long noServidasEliminadas = hotelandes.eliminarBebidasNoServidas();
			List <VOBebida> listaBebidas2 = hotelandes.darVOBebidas();
			
			long bebEliminadas1 = hotelandes.eliminarBebidaPorId(bebida1.getId ());
			long bebEliminadas2 = hotelandes.eliminarBebidaPorId(bebida2.getId ());
			long bebEliminadas3 = hotelandes.eliminarBebidaPorId(bebida3.getId ());
			long tbEliminados = hotelandes.eliminarTipoBebidaPorNombre (nombreTipoBebida);
...
//			e.printStackTrace();
    ...
    public void demoElimNoServidas2 ( )
    {
    	try 
    	{
			...
			VOBebida bebida2 = hotelandes.adicionarBebida("Gato Negro", tipoBebida.getId (), 11);
			VOBebida bebida3 = hotelandes.adicionarBebida("Don Pedro", tipoBebida.getId (), 12);
			VOBar bar1 = hotelandes.adicionarBar ("Los Amigos", "Bogotá", "Bajo", 2);
			hotelandes.adicionarSirven (bar1.getId (), bebida1.getId (), "diurno");
			
			List <VOTipoBebida> listaTiposBebida = hotelandes.darVOTiposBebida();
			List <VOBebida> listaBebidas1 = hotelandes.darVOBebidas();
			List <VOBar> bares = hotelandes.darVOBares ();
			List <VOSirven> sirven = hotelandes.darVOSirven ();
			long noServidasEliminadas = hotelandes.eliminarBebidasNoServidas();
			List <VOBebida> listaBebidas2 = hotelandes.darVOBebidas();
			
			long sirvenEliminados = hotelandes.eliminarSirven(bar1.getId (), bebida1.getId ());
			long bebEliminadas1 = hotelandes.eliminarBebidaPorId(bebida1.getId ());
			long bebEliminadas2 = hotelandes.eliminarBebidaPorId(bebida2.getId ());
			long bebEliminadas3 = hotelandes.eliminarBebidaPorId(bebida3.getId ());
			long tbEliminados = hotelandes.eliminarTipoBebidaPorNombre (nombreTipoBebida);
			long baresEliminados = hotelandes.eliminarBarPorNombre ("Los Amigos");
...
//			e.printStackTrace();
    ...
    public void demoBar ( )
    {
		try 
		{
			...
			List <VOBar> lista = hotelandes.darVOBares ();
...
//			e.printStackTrace();
    ...
    public void demoBaresBebidas ( )
    {
		try 
		{
			...
			// ATENCIÓN: En una aplicación real, los datos JAMÁS están en el código
			boolean errorTipoBebida = false;
			VOTipoBebida tipoBebida = hotelandes.adicionarTipoBebida ("Vino tinto");
			if (tipoBebida == null)
			{
				tipoBebida = hotelandes.darTipoBebidaPorNombre ("Vino tinto");
				errorTipoBebida = true;
			}
			VOBebida bebida1 = hotelandes.adicionarBebida ("120", tipoBebida.getId (), 10);
			VOBebida bebida2 = hotelandes.adicionarBebida ("121", tipoBebida.getId (), 10);
			VOBebida bebida3 = hotelandes.adicionarBebida ("122", tipoBebida.getId (), 10);
			VOBebida bebida4 = hotelandes.adicionarBebida ("123", tipoBebida.getId (), 10);
			VOBebida bebida5 = hotelandes.adicionarBebida ("124", tipoBebida.getId (), 10);
			VOBar bar1 = hotelandes.adicionarBar ("Los Amigos1", "Bogotá", "Bajo", 2);
			VOBar bar2 = hotelandes.adicionarBar ("Los Amigos2", "Bogotá", "Bajo", 3);
			VOBar bar3 = hotelandes.adicionarBar ("Los Amigos3", "Bogotá", "Bajo", 4);
			VOBar bar4 = hotelandes.adicionarBar ("Los Amigos4", "Medellín", "Bajo", 5);
			hotelandes.adicionarSirven (bar1.getId (), bebida1.getId (), "diurno");
			hotelandes.adicionarSirven (bar1.getId (), bebida2.getId (), "diurno");
			hotelandes.adicionarSirven (bar2.getId (), bebida1.getId (), "diurno");
			hotelandes.adicionarSirven (bar2.getId (), bebida2.getId (), "diurno");
			hotelandes.adicionarSirven (bar2.getId (), bebida3.getId (), "diurno");
			hotelandes.adicionarSirven (bar3.getId (), bebida1.getId (), "diurno");
			hotelandes.adicionarSirven (bar3.getId (), bebida2.getId (), "diurno");
			hotelandes.adicionarSirven (bar3.getId (), bebida3.getId (), "diurno");
			hotelandes.adicionarSirven (bar3.getId (), bebida4.getId (), "diurno");
			hotelandes.adicionarSirven (bar3.getId (), bebida5.getId (), "diurno");
			
			List <VOTipoBebida> listaTiposBebida = hotelandes.darVOTiposBebida ();
			List <VOBebida> listaBebidas = hotelandes.darVOBebidas ();
			List <VOBar> listaBares = hotelandes.darVOBares ();
			List <VOSirven> listaSirven = hotelandes.darVOSirven ();

			List <long []> listaByB = hotelandes.darBaresYCantidadBebidasSirven();

			long sirvenEliminados = hotelandes.eliminarSirven (bar1.getId (), bebida1.getId ());
			sirvenEliminados += hotelandes.eliminarSirven (bar1.getId (), bebida2.getId ());
			sirvenEliminados += hotelandes.eliminarSirven (bar2.getId (), bebida1.getId ());
			sirvenEliminados += hotelandes.eliminarSirven (bar2.getId (), bebida2.getId ());
			sirvenEliminados += hotelandes.eliminarSirven (bar2.getId (), bebida3.getId ());
			sirvenEliminados += hotelandes.eliminarSirven (bar3.getId (), bebida1.getId ());
			sirvenEliminados += hotelandes.eliminarSirven (bar3.getId (), bebida2.getId ());
			sirvenEliminados += hotelandes.eliminarSirven (bar3.getId (), bebida3.getId ());
			sirvenEliminados += hotelandes.eliminarSirven (bar3.getId (), bebida4.getId ());
			sirvenEliminados += hotelandes.eliminarSirven (bar3.getId (), bebida5.getId ());
			long bebidasEliminadas = hotelandes.eliminarBebidaPorNombre ("120");
			bebidasEliminadas += hotelandes.eliminarBebidaPorNombre ("121");
			bebidasEliminadas += hotelandes.eliminarBebidaPorNombre ("122");
			bebidasEliminadas += hotelandes.eliminarBebidaPorNombre ("123");
			bebidasEliminadas += hotelandes.eliminarBebidaPorNombre ("124");
			long tbEliminados = hotelandes.eliminarTipoBebidaPorNombre ("Vino tinto");
			long baresEliminados = hotelandes.eliminarBarPorNombre ("Los Amigos1");
			baresEliminados += hotelandes.eliminarBarPorNombre ("Los Amigos2");
			baresEliminados += hotelandes.eliminarBarPorNombre ("Los Amigos3");
			baresEliminados += hotelandes.eliminarBarPorId (bar4.getId ());
...
//			e.printStackTrace();
    ...
    public void demoAumentarSedesBaresEnCiudad ( )
    {
		try 
		{
			...
			long baresModificados = hotelandes.aumentarSedesBaresCiudad("Bogotá");
			List <VOBar> listaBares2 = hotelandes.darVOBares ();

			long baresEliminados = hotelandes.eliminarBarPorId (bar1.getId ());
			baresEliminados += hotelandes.eliminarBarPorId (bar2.getId ());
			baresEliminados += hotelandes.eliminarBarPorId (bar3.getId ());
			baresEliminados += hotelandes.eliminarBarPorId (bar4.getId ());
			// Generación de la cadena de caracteres con la traza de la ejecución de la demo
...
//			e.printStackTrace();
	...
	public void demoBebedor ( )
    {
		try 
		{
    		// Ejecución de la demo y recolección de los resultados
			// ATENCIÓN: En una aplicación real, los datos JAMÁS están en el código
			VOBebedor bdor1 = hotelandes.adicionarBebedor ("Pepito", "Bogotá", "Alto");
			VOBebedor bdor2 = hotelandes.adicionarBebedor ("Pepito", "Medellín", "Alto");
			VOBebedor bdor3 = hotelandes.adicionarBebedor ("Pedrito", "Cali", "Alto");
			
			List <VOBebedor> bebedores = hotelandes.darVOBebedores();
			VOBebedor bdor5 = hotelandes.darBebedorPorId(bdor1.getId ());
			VOBebedor bdor6 = hotelandes.darBebedorPorId(0);
			List <VOBebedor> pepitos = hotelandes.darVOBebedoresPorNombre("Pepito");
			List <VOBebedor> pedritos = hotelandes.darVOBebedoresPorNombre("Pedrito");
			
			long pepitosEliminados = hotelandes.eliminarBebedorPorNombre ("Pepito");
			long pedritosEliminados = hotelandes.eliminarBebedorPorNombre ("Pedrito");
...
//			e.printStackTrace();
    ...
    public void demoDarBebedorCompleto ( )
    {
		try 
		{
			...
			hotelandes.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			hotelandes.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "nocturno");
			hotelandes.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "todos");
			hotelandes.adicionarGustan (bdor1.getId (), bebida1.getId ());

			List <VOTipoBebida> listaTipos = hotelandes.darVOTiposBebida();
			List <VOBebida> listaBebidas = hotelandes.darVOBebidas();
			List <VOBar> listaBares = hotelandes.darVOBares ();
			List <VOBebedor> bebedores = hotelandes.darVOBebedores();
			List <VOGustan> listaGustan = hotelandes.darVOGustan();
			List <VOVisitan> listaVisitan = hotelandes.darVOVisitan();

			VOBebedor bdor2 = hotelandes.darBebedorCompleto(bdor1.getId ());

			long gustanEliminados = hotelandes.eliminarGustan (bdor1.getId (), bebida1.getId ());
			long bebidasEliminadas = hotelandes.eliminarBebidaPorNombre ("120");
			long tiposEliminados = hotelandes.eliminarTipoBebidaPorNombre ("Vino tinto");
			long [] bebedorVisitasEliminados = hotelandes.eliminarBebedorYVisitas_v1 (bdor1.getId ());
			long baresEliminados = hotelandes.eliminarBarPorNombre ("Los Amigos");
...
//			e.printStackTrace();
    ...
    public void demoEliminarBebedorYVisitas_v2 ( )
    {
		try 
		{
			...
			long bebidasEliminadas = hotelandes.eliminarBebidaPorNombre ("120");
			long tiposEliminados = hotelandes.eliminarTipoBebidaPorNombre ("Vino tinto");
			long [] bebedorVisitasEliminados = hotelandes.eliminarBebedorYVisitas_v2 (bdor1.getId ());
			long baresEliminados = hotelandes.eliminarBarPorNombre ("Los Amigos");
    ...
    */
    public void demoCambiarCiudadBebedor ( )
    {
		try 
		{
			...
			List<VOBebedor> bebedores1 = hotelandes.darVOBebedores ();
			long bebedoresActualizados = hotelandes.cambiarCiudadBebedor (bdor1.getId (), "Medellín");
			List<VOBebedor> bebedores2 = hotelandes.darVOBebedores ();
			
			long bebedoresEliminados = hotelandes.eliminarBebedorPorNombre ("Pepito");
...
//			e.printStackTrace();
    ...
    public void demoBebedoresYNumVisitasRealizadas ( )
    {
		try 
		{
			...
			VOBar bar4 = hotelandes.adicionarBar ("Los Amigos4", "Medellín", "Bajo", 5);
			VOBebedor bdor1 = hotelandes.adicionarBebedor ("Pepito", "Bogotá", "Alto");
			VOBebedor bdor2 = hotelandes.adicionarBebedor ("Juanito", "Bogotá", "Alto");
			VOBebedor bdor3 = hotelandes.adicionarBebedor ("Carlitos", "Medellín", "Alto");
			VOBebedor bdor4 = hotelandes.adicionarBebedor ("Luis", "Cartagena", "Medio");
			hotelandes.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			hotelandes.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "nocturno");
			hotelandes.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "todos");
			hotelandes.adicionarVisitan (bdor1.getId (), bar2.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			hotelandes.adicionarVisitan (bdor1.getId (), bar3.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			hotelandes.adicionarVisitan (bdor2.getId (), bar3.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			hotelandes.adicionarVisitan (bdor2.getId (), bar4.getId (), new Timestamp (System.currentTimeMillis()), "diurno");

			List<VOBar> bares = hotelandes.darVOBares();
			List<VOBebedor> bebedores = hotelandes.darVOBebedores();
			List<VOVisitan> visitan = hotelandes.darVOVisitan ();
			List<Object []> bebedoresYNumVisitas = hotelandes.darBebedoresYNumVisitasRealizadas ();

			long [] elimBdor1 = hotelandes.eliminarBebedorYVisitas_v1 (bdor1.getId ());
			long [] elimBdor2 = hotelandes.eliminarBebedorYVisitas_v1 (bdor2.getId ());
			long [] elimBdor3 = hotelandes.eliminarBebedorYVisitas_v1 (bdor3.getId ());
			long [] elimBdor4 = hotelandes.eliminarBebedorYVisitas_v1 (bdor4.getId ());
			long baresEliminados = hotelandes.eliminarBarPorNombre ("Los Amigos1");
			baresEliminados += hotelandes.eliminarBarPorNombre ("Los Amigos2");
			baresEliminados += hotelandes.eliminarBarPorNombre ("Los Amigos3");
			baresEliminados += hotelandes.eliminarBarPorNombre ("Los Amigos4");
...
//			e.printStackTrace();
    ...
    public void demoBebedoresDeCiudad ( )
    {
		try 
		{
			...
			VOBar bar4 = hotelandes.adicionarBar ("Los Amigos4", "Medellín", "Bajo", 5);
			VOBebedor bdor1 = hotelandes.adicionarBebedor ("Pepito", "Bogotá", "Alto");
			VOBebedor bdor2 = hotelandes.adicionarBebedor ("Juanito", "Medellín", "Alto");
			VOBebedor bdor3 = hotelandes.adicionarBebedor ("Pedrito", "Medellín", "Alto");
			hotelandes.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			hotelandes.adicionarVisitan (bdor1.getId (), bar2.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			hotelandes.adicionarVisitan (bdor1.getId (), bar3.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			hotelandes.adicionarVisitan (bdor2.getId (), bar3.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			hotelandes.adicionarVisitan (bdor1.getId (), bar4.getId (), new Timestamp (System.currentTimeMillis()), "diurno");

			List<VOBar> bares = hotelandes.darVOBares();
			List<VOBebedor> bebedores = hotelandes.darVOBebedores();
			List<VOVisitan> visitan = hotelandes.darVOVisitan ();
			long bebedoresBogota = hotelandes.darCantidadBebedoresCiudadVisitanBares ("Bogotá");
			long bebedoresMedellin = hotelandes.darCantidadBebedoresCiudadVisitanBares ("Medellín");

			long [] elimBdor1 = hotelandes.eliminarBebedorYVisitas_v1 (bdor1.getId ());
			long [] elimBdor2 = hotelandes.eliminarBebedorYVisitas_v1 (bdor2.getId ());
			long elimBdor3 = hotelandes.eliminarBebedorPorId (bdor3.getId ());
			long baresEliminados = hotelandes.eliminarBarPorNombre ("Los Amigos1");
			baresEliminados += hotelandes.eliminarBarPorNombre ("Los Amigos2");
			baresEliminados += hotelandes.eliminarBarPorNombre ("Los Amigos3");
			baresEliminados += hotelandes.eliminarBarPorNombre ("Los Amigos4");
...
//			e.printStackTrace();
    ...
    public void demoGustan ( )
    {
		try 
		{
			...
			List <VOTipoBebida> listaTiposBebida = hotelandes.darVOTiposBebida ();
			List <VOBebida> listaBebidas = hotelandes.darVOBebidas ();
			List <VOBebedor> listaBebedores = hotelandes.darVOBebedores ();
			List <VOGustan> listaGustan = hotelandes.darVOGustan();
			long gustanEliminados = hotelandes.eliminarGustan (bdor1.getId (), bebida1.getId ());
			long bebidasEliminadas = hotelandes.eliminarBebidaPorNombre ("120");
			long tbEliminados = hotelandes.eliminarTipoBebidaPorNombre ("Vino tinto");
...
//			e.printStackTrace();
    ...
    public void demoVisitan ( )
    {
		try 
		{
			...
			List <VOBebedor> listaBebedores = hotelandes.darVOBebedores ();
			List <VOVisitan> listaVisitan = hotelandes.darVOVisitan();
			long visitanEliminados = hotelandes.eliminarVisitan (bdor1.getId (), bar1.getId ());
			long baresEliminados = hotelandes.eliminarBarPorNombre ("Los Amigos1");
			long bebedoresEliminadas = hotelandes.eliminarBebedorPorNombre ("Pepito");
