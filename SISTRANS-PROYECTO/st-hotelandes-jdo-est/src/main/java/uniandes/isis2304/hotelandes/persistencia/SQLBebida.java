...
/**
 * Clase que encapsula los métodos que hacen acceso a la base de datos para el concepto BEBIDA de HotelAndes
...
class SQLBebida 
{
	 ...
	 */
	public SQLBebida (PersistenciaHotelAndes pp)
	{
		this.pp = pp;
	}
	
	/**
	 * Crea y ejecuta la sentencia SQL para adicionar una BEBIDA a la base de datos de HotelAndes
	...
	/**
	 * Crea y ejecuta la sentencia SQL para eliminar BEBIDAS de la base de datos de HotelAndes, por su nombre
	 * @param pm - El manejador de persistencia
	...
	/**
	 * Crea y ejecuta la sentencia SQL para eliminar BEBIDAS de la base de datos de HotelAndes, por su identificador
	 * @param pm - El manejador de persistencia
	 * @param idBebida - El identificador de la bebida
	 * @return EL número de tuplas eliminadas
	 */
