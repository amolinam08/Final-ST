...
/**
 * Clase que encapsula los métodos que hacen acceso a la base de datos para el concepto GUSTAN de HotelAndes
...
class SQLGustan 
{
	 ...
	 */
	public SQLGustan (PersistenciaHotelAndes pp)
	{
		this.pp = pp;
	}
	
	/**
	 * Crea y ejecuta la sentencia SQL para adicionar un GUSTAN a la base de datos de HotelAndes
	...
	/**
	 * Crea y ejecuta la sentencia SQL para eliminar UN GUSTAN de la base de datos de HotelAndes, por sus identificador
	 * @param pm - El manejador de persistencia
	 * @param idBebedor - El identificador del bebedor
	 * @param idBebida - El identificador de la bebida
