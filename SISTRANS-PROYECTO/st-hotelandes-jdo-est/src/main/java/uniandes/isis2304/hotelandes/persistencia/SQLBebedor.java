...
/**
 * Clase que encapsula los métodos que hacen acceso a la base de datos para el concepto BEBEDOR de HotelAndes
...
class SQLBebedor 
{
	 ...
	 */
	public SQLBebedor (PersistenciaHotelAndes pp)
	{
		this.pp = pp;
	}
	
	/**
	 * Crea y ejecuta la sentencia SQL para adicionar un BEBEDOR a la base de datos de HotelAndes
	...
	/**
	 * Crea y ejecuta la sentencia SQL para eliminar BEBEDORES de la base de datos de HotelAndes, por su nombre
	 * @param pm - El manejador de persistencia
	 * @param nombre - El nombre del bebedor
	...
	/**
	 * Crea y ejecuta la sentencia SQL para eliminar UN BEBEDOR de la base de datos de HotelAndes, por su identificador
	 * @param pm - El manejador de persistencia
	 ...
	 * base de datos de HotelAndes. Incluye, con 0, los bebedores que no han realizado visitas 
	 * @param pm - El manejador de persistencia
