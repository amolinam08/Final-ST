...
/**
 * Clase que encapsula los métodos que hacen acceso a la base de datos para el concepto SIRVEN de HotelAndes
...
class SQLSirven 
{
	...
	/**
	 * Crea y ejecuta la sentencia SQL para adicionar un SIRVEN a la base de datos de HotelAndes
	...
	/**
	 * Crea y ejecuta la sentencia SQL para eliminar UN SIRVEN de la base de datos de HotelAndes, por sus identificador
	 * @param pm - El manejador de persistencia
	 * @param idBar - El identificador del bar
	 * @param idBebida - El identificador de la bebida
